    ...
    <header className="flex h-16 items-center justify-between border-b border-surface-200 bg-white px-4 lg:px-6">
      ...
      <div className="relative">
        <button
          ...
          className="flex items-center gap-2 rounded-lg px-2 py-1.5 text-sm font-medium text-surface-700 hover:bg-surface-100"
        >
        ...
        {menuOpen && (
          <>
            ...
            />
            <div className="absolute right-0 z-20 mt-2 w-44 rounded-lg border border-surface-200 bg-white py-1 shadow-lg">
              <button
                onClick={logout}
                className="flex w-full items-center gap-2 px-3 py-2 text-sm text-surface-700 hover:bg-surface-100"
              >
